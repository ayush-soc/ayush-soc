...
I am a **3rd Year Computer Science Engineering student at KIIT**, deeply passionate about cybersecurity, threat detection, and incident response.

My focus is on understanding defensive security—not just running tools, but knowing exactly how attacks happen so I can build systems to detect and defeat them.

Right now, I'm focused on:
* 🌐 Deep-diving into network packets & log behaviors
* 🧠 Automating incident response & endpoint forensics (like Ghost Triage)
* 🗺️ Mapping real-world adversary tactics to frameworks
